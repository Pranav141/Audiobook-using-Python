...
text_area = st.ScrolledText(root,width = 60,height = 18,font = ("Times New Roman",15))
...
text_area.focus()
#def help():
    #messagebox.showinfo("Contact","You can contact me at abc@gmail.com for further assisstance")  

accent_option=["India","USA","UK","Australia","Canada","South Africa"]
clicked=StringVar()
clicked.set(accent_option[0])
pdf=""
#lang_option=["English","Hindi"]
#clicked1=StringVar()
#clicked1.set(lang_option[0])  
...
#language
#lang=Label(root,text="Choose Language",bg="yellow",bd=8).grid(row=5,column=0)
#drop1=OptionMenu(root, clicked1, *lang_option).grid(row=5,column=1)
